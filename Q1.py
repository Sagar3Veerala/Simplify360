class TaskScheduler:
    ...
    def add_task(self, task_id, duration):
        ...
        # Time Complexity: O(1) for each task added
        # Space Complexity: O(1) for each task added, O(n) overall where n is the number of tasks
    ...
    def add_dependency(self, from_task, to_task):
        ...
        # Time Complexity: O(1) for each dependency added
        # Space Complexity: O(1) for each dependency added, O(m) overall where m is the number of dependencies
    ...
    def compute_earliest_finish_times(self):
        ...
        # Time Complexity: O(n + m), where n is the number of tasks and m is the number of dependencies
        # Space Complexity: O(n) for storing earliest start and finish times, and queue
    ...
    def compute_latest_finish_times(self, earliest_finish):
        ...
        # Time Complexity: O(n + m), where n is the number of tasks and m is the number of dependencies
        # Space Complexity: O(n) for storing latest start and finish times, and queue
